...
import { bfhlFormSchema, type BfhlResponse } from "@shared/schema";
...
type FilterType = "Numbers" | "Alphabets" | "Highest Alphabet";
...
export default function Home() {
  ...
  const getFilteredData = () => {
    ...
    if (activeFilters.includes("Highest Alphabet")) {
